      ...
      >
        ...
        >
          <Image
            ...
            width={200}
            height={200}
            className="rounded-full mx-auto border-4 border-purple-500/20 shadow-2xl dark:shadow-purple-500/30 hover:shadow-lg transition-shadow duration-300 cursor-crosshair"
          />
        </motion.div>
